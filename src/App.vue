...
export default {
  ...
  methods: {
    submitForm() {
      ...
      this.total = parseInt(this.data.nilaimtk) + parseInt(this.data.nilaiindo) + parseInt(this.data.nilaiipa);
    ...
    if (this.total > 240) {
      ...
      document.getElementById('a').innerHTML = ("Nama : " + this.data.nama)
       ...
       + ("<br>Nilai IPA : " + this.data.nilaiipa) + ("<br>Total : " + this.total) + ("<br>Keterangan : " +this.keterangan);
